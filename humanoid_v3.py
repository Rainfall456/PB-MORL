...
class HumanoidEnv(mujoco_env.MujocoEnv, utils.EzPickle):
    ...
    def step(self, action):
        ...
        #return observation, np.array([forward_reward, -ctrl_cost, healthy_reward]), done, info
        return observation, np.array([forward_reward+healthy_reward, -ctrl_cost]), done, info
...
register(id='MO_humanoid-v0', entry_point='humanoid_v3:HumanoidEnv')
